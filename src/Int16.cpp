...
AbstractVM::Int16::Int16(const std::string &value) {
...
AbstractVM::eOperandType AbstractVM::Int16::getType() const {
    return INT16;
}

AbstractVM::IOperand *AbstractVM::Int16::getResult(AbstractVM::eOperandType type, AbstractVM::eOperation op, const AbstractVM::IOperand &rhs) const {
